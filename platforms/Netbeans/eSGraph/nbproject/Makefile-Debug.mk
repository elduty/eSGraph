...
${OBJECTDIR}/_ext/52a4beb5/Node.o: ../../../src/Node.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../../include -I../../../external/glm -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/52a4beb5/Node.o ../../../src/Node.cpp
...
${TESTDIR}/_ext/76fcd107/NodeTests.o: ../../../tests/src/NodeTests.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../../include -I../../../external/glm -I../../../external/googletest/googletest/include -I../../../tests/include -I../../../external/googletest/googletest -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/76fcd107/NodeTests.o ../../../tests/src/NodeTests.cpp
...
${OBJECTDIR}/_ext/52a4beb5/Node_nomain.o: ${OBJECTDIR}/_ext/52a4beb5/Node.o ../../../src/Node.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I../../../include -I../../../external/glm -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/52a4beb5/Node_nomain.o ../../../src/Node.cpp;\
	else  \
